...
public class Controller {
    ...
    // D pad variables
    private static boolean dPadIsReleased = true;
    ...
    protected static boolean dPad_Released() {
    ...
    protected static boolean getdPadRightPressed() {
        if (dPad_Released()) {
            dPadIsReleased = true;
        }

        if (dPad_Right() && dPadIsReleased == true) {
            dPadIsReleased = false;
            return true;
        }
    ...
    protected static boolean getdPadLeftPressed() {
        if (dPad_Released()) {
            dPadIsReleased = true;
        }

        if (dPad_Left() && dPadIsReleased == true) {
            dPadIsReleased = false;
            return true;
        }
