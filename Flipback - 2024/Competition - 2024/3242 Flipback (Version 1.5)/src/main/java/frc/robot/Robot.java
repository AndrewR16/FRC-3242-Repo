...
public class Robot extends TimedRobot {
  ...
  // Autonomous routines
  private static final String auto_default = "driveBackwardsAuto";
  private static final String auto_shoot = "shootAuto";
  private String auto_selectedAuto;
  private final SendableChooser<String> autonomousSelector = new SendableChooser<String>();
  ...
  public void robotInit() {
    ...
    // Autonomous chooser
    autonomousSelector.setDefaultOption("Leave Start Zone", auto_default);
    autonomousSelector.addOption("Shoot and Leave", auto_shoot);
    SmartDashboard.putData("Autonomous Routines", autonomousSelector);
  ...
  public void autonomousInit() {
    ...
    auto_selectedAuto = autonomousSelector.getSelected();
  }
  ...
  public void autonomousPeriodic() {
    ...
    switch (auto_selectedAuto) {
      ...
      case auto_shoot:
        // *Shoot, strafe right, drive forwards
        if (autonomousCommands.runFor(0.5)) {
          m_intake.set(1);
        } else if (autonomousCommands.runFor(4)) {
          m_intake.set(1);
          runShooter(1);
        } else if (autonomousCommands.runFor(2)) {
          mDrive.driveCartesian(0.0, -0.3, 0);
        } else if (autonomousCommands.runFor(2)) {
          mDrive.driveCartesian(0.3, 0.0, 0.0);
        }
        break;
